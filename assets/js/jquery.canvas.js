(function ($) {
  ...
  var init = function (index, input, options) {
    ...
    settings = $.extend(
      {
        imageUrl: $(this).attr("isimb-6310-image-url"),
      },
      options
    );
    ...
    $reset = $(
      '<div class="isimb-6310-submenu"><div class="isimb-6310-clear"><i class="fas fa-eraser"></i> Clear</div><div class="isimb-6310-undo"><i class="fas fa-undo"></i> Undo</div></div>'
    );
    $canvas = $("<canvas>");
    ...
    $(`${options} .isimb-6310-canvas-wrapper`).append($reset, "<br>", $canvas);
    ...
    $(document).find(".isimb-6310-clear").click(reset);
